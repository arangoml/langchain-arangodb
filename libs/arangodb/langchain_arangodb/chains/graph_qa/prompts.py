...
- Each entry in Chat History includes the User Input, the AQL Query generated by the AI Model, and the AQL Result. Use all of them to generate the AQL Query.
