...
- If the Chat History entry is a query-response pair containing User Input, AQL Query, and AQL Result, use all of them to generate the AQL Query.
- If the Chat History entry is a feedback message, use it to improve the AQL Query. Do not use it to generate the AQL Query.
